    ...
    <div className="page-wrap space-y-10 sm:space-y-12">
      <section className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div className="animate-fade-up">
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-semibold text-slate-950 dark:text-white sm:text-5xl lg:text-6xl">
          ...
          <p className="mt-6 max-w-2xl text-base text-slate-600 dark:text-slate-300 sm:text-lg">
            NextJob combines curated opportunities, external apply links, ATS-friendly resume support,
            downloadable templates, and AI-powered interview preparation without asking users to create
            an account.
          </p>
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
            ...
            <Link to="/resume-builder" className="btn-secondary w-full sm:w-auto">
              Build Resume <FileText size={16} />
            </Link>
          </div>
        </div>

        <div className="glass-panel-strong animate-float p-5 sm:p-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <StatCard
          value={`${jobs.length}+`}
          label="Open job roles from the admin dashboard"
          accent="text-tide dark:text-teal-200"
        />
        <StatCard
          value={`${internships.length}+`}
          label="Internship opportunities with external apply links"
          accent="text-amber-600 dark:text-amber-200"
        />
        <StatCard
          value="24/7"
          label="Self-serve resume and interview prep access"
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <div className="glass-panel p-5 sm:p-6">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-300">
            Enter your skills, education, projects, and experience in a focused form, then download a
            clean recruiter-friendly layout.
          </p>
          <Link to="/resume-builder" className="btn-primary mt-6 w-full sm:w-auto">
        ...
        <div className="glass-panel p-5 sm:p-6">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-300">
            Keep a few design directions available for different audiences like software, general, and
            internship applications.
          </p>
          <Link to="/resume-templates" className="btn-primary mt-6 w-full sm:w-auto">
        ...
        <div className="glass-panel p-5 sm:p-6">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-300">
            The backend can generate tailored questions through the OpenAI API while still providing a
            graceful fallback during setup.
          </p>
          <Link to="/ai-interview" className="btn-primary mt-6 w-full sm:w-auto">
